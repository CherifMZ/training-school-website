...
require_once($relativePath.'/Latreche_Mohamed_Cherif_Zouaoui_SIL1/controllers/espaceEleveController.php');

class espaceEleveView {
            ...
            <?php
                ...
                echo '<div class="row">';
                    ...
                    while($row=$qtf->fetch()) {
                        ...
                        if (in_array(" primaire",$array) || in_array(" moyen", $array) || in_array(" secondaire", $array)
                            || in_array("primaire",$array) || in_array("moyen", $array) || in_array("secondaire", $array))  {
                    ?>
