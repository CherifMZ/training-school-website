...
require_once($relativePath.'/Latreche_Mohamed_Cherif_Zouaoui_SIL1/controllers/ControllerInfoPratiqueM.php');

class informationPratiqueM {
...
<?php
    ...
    public function contenu() {
        ...
        $controller = new ControllerInfoPratiqueM();
        $query = $controller->getInfo(3);
