...
require_once($relativePath.'/Latreche_Mohamed_Cherif_Zouaoui_SIL1/controllers/ControllerInfoPratiqueS.php');

class informationPratiqueS {
...
<?php
    ...
    public function contenu() {
        ...
        $controller = new ControllerInfoPratiqueS();
        $query = $controller->getInfo(4);
