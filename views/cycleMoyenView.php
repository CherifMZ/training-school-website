...
require_once($relativePath.'/Latreche_Mohamed_Cherif_Zouaoui_SIL1/controllers/ControllerCycleMoyen.php');

class cycleMoyenView {
    ...
    public function contenu() {//premier cadre
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <p>Vous trouverez ici l'emploi du temps global du cycle Moyen</p>
                        <a href="http://localhost/latreche_mohamed_cherif_zouaoui_SIL1/controllers/ControllerAffichageEdt.php?id=<?php echo 3; ?>">Cliquez ici</a>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <p>Vous trouverez ici la liste des enseignants du cycle Moyen</p>
                        <a href="http://localhost/latreche_mohamed_cherif_zouaoui_SIL1/controllers/ControllerListeEns.php?id=<?php echo 3; ?>">
                        Cliquez ici</a>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <p>Vous trouverez ici les informations pratiques du cycle Moyen</p>
                        <a href="../views/informationPratiqueM.php">Cliquez ici</a>
                    </div>
                    <div class="col-sm-3">
        ...
        <?php //deuxième cadre
            ...
            foreach ($qtf as $row) {
                ...
                if (in_array(" moyen",$array) || in_array("moyen", $array)) {
    ...
    public function afficherMoyenPage() {
        echo '<html>';
        $this->head();
        $this->mBody();
        echo '</html>';
