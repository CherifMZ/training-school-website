...
class infoParentView {
    public function head() {
        ?>  
        <head>
            <meta charset="UTF-8">
            <title>Informations Parents</title>
...
<br><br>
    ...
    public function profilEnfant() {
        ?>

        <h1><center> Profil des enfants </center></h1>
        <center><img src="../images/info/personal.png" style ="width: 150px; height: 150px;"> </center>
        <br>
...
<br><br>
    ...
    public function note() {
        ...
        <h1><center> Notes des enfants</center></h1>
