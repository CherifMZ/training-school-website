...
require_once($relativePath.'/Latreche_Mohamed_Cherif_Zouaoui_SIL1/controllers/ControllerCyclePrimaire.php');

class cyclePrimaireView {
    ...
    public function contenu() {//premier cadre
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        ...
                        <p>Vous trouverez ici l'emploi du temps global du cycle Primaire</p>
                        <a href="http://localhost/latreche_mohamed_cherif_zouaoui_SIL1/controllers/ControllerAffichageEdt.php?id=<?php echo 2; ?>">Cliquez ici</a>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <p>Vous trouverez ici la liste des enseignants du cycle Primaire</p>
                        <a href="http://localhost/latreche_mohamed_cherif_zouaoui_SIL1/controllers/ControllerListeEns.php?id=<?php echo 2; ?>">
                        Cliquez ici</a>
                    </div>
                    <div class="col-sm-3">
                        ...
                        <p>Vous trouverez ici les informations pratiques du cycle Primaire</p>
                        <a href="../views/informationPratiqueP.php">Cliquez ici</a>
                    </div>
                    <div class="col-sm-3">
        ...
        <?php //deuxième cadre
            ...
            foreach ($qtf as $row) {
                ...
                if (in_array(" primaire",$array) || in_array("primaire", $array)) {
    ...
    public function afficherPrimairePage() {
        echo '<html>';
        $this->head();
        $this->pBody();
        echo '</html>';
